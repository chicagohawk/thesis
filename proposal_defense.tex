...
\subsection{Timeline}
\begin{itemize}
    \item Apr: Write proposal defense slides. Wrap up the proof of theorem \ref{theorem: 2}.
    ...
    \item Jul: Hold a committee meeting for progress report.
    \item Jul-Oct: Implement optimization on the return bend example.
    \item Aug-Nov: Write thesis.
    \item Jan: Defend thesis.
\end{itemize}
