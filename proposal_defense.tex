...
such a mapping is determined by the adaptive functional $F_i$'s or $q_i$'s.
Therefore, the adaptive functionals can be inferred with a large number of samples,
